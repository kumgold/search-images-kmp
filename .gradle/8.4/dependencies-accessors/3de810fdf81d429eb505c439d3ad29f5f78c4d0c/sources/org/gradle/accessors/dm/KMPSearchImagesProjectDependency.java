...
@NonNullApi
public class KMPSearchImagesProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KMPSearchImagesProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
